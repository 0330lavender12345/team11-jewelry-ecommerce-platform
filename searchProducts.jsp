...
<html>
    <%
        ...
        String sql = "SELECT * FROM team11_silverwrb.products WHERE `isAvailable` = TRUE";
...
<head>
    ...
    <title>搜尋結果 | Search Results</title>
...
<body>
                ...
                <script>
                    $(document).ready(function(){
                        $('#productName').on('input', function(){
                            ...
                            if(inputVal){
                                $.get('suggestProducts.jsp', {productName: inputVal}, function(data){
                        ...
                        $('#suggestion').on('click', 'div', function(){
                            var selectedProduct = $(this).text();
                            $.get('getProductInfo.jsp', {productName: selectedProduct}, function(data){
                    ...
                    <div class="grid-container">
                        ...
                        %>
                            <div class='card'>
                                ...
                                <a href='prdintro.jsp'><h4><%= productNameResult %></h4></a>
                                <h5>$<%= productPrice %></h5>
                                <form id="addToCartForm" method="post" action="addcart.jsp">
                                    <input type="hidden" name="productName" value="<%= productNameResult %>">
                                    <input type="hidden" name="productPrice" value="<%= productPrice %>">
                                    <input type="hidden" name="productImg" value="<%= productImg %>">
									<input type="button" class="card-button" onclick="addToCart('<%= rs.getRow() %>')">                              
								</form>
                            </div>
                        <%
                        }
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const searchForm = document.querySelector('form[action="searchProducts.jsp"]');
